...
func answer_BOJ_1004() {
    ...
    while T > 0 {
        ...
        for _ in 0...N {
            ...
            let fromStartPoint = figureDistance(x1: startPoint.x1, y1: startPoint.y1, x2: input[0], y2: input[1], r: input[2])
            let fromEndPoint = figureDistance(x1: endPoint.x2, y1: endPoint.y2, x2: input[0], y2: input[1], r: input[2])
